...
%      START_STOP, by itself, creates a new START_STOP or raises the existing
%      singleton*.
%
%      H = START_STOP returns the handle to a new START_STOP or the handle to
%      the existing singleton*.
%
%      START_STOP('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in START_STOP.M with the given input arguments.
%
%      START_STOP('Property','Value',...) creates a new START_STOP or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before start_stop_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to start_stop_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help start_stop

% Last Modified by GUIDE v2.5 28-Mar-2013 20:41:07

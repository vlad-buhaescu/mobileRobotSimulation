...
%      WARN_DEF_WORK, by itself, creates a new WARN_DEF_WORK or raises the existing
%      singleton*.
%
%      H = WARN_DEF_WORK returns the handle to a new WARN_DEF_WORK or the handle to
%      the existing singleton*.
%
%      WARN_DEF_WORK('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in WARN_DEF_WORK.M with the given input arguments.
%
%      WARN_DEF_WORK('Property','Value',...) creates a new WARN_DEF_WORK or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before warn_def_work_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to warn_def_work_OpeningFcn via varargin.
%
...
function varargout = warn_def_work_OutputFcn(hObject, eventdata, handles) 

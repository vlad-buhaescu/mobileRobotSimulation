...
% WARN_MESAGE MATLAB code for warn_mesage.fig
%      WARN_MESAGE, by itself, creates a new WARN_MESAGE or raises the existing
%      singleton*.
%
%      H = WARN_MESAGE returns the handle to a new WARN_MESAGE or the handle to
%      the existing singleton*.
%
%      WARN_MESAGE('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in WARN_MESAGE.M with the given input arguments.
%
%      WARN_MESAGE('Property','Value',...) creates a new WARN_MESAGE or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before warn_mesage_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to warn_mesage_OpeningFcn via varargin.
%
...
% Last Modified by GUIDE v2.5 27-Feb-2013 16:33:37
